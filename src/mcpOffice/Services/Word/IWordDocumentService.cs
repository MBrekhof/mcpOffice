...
public interface IWordDocumentService
{
    ...
    string MailMerge(string templatePath, string outputPath, string dataJson, bool overwrite = false);
    string Convert(string inputPath, string outputPath, string? format, bool overwrite = false);
}
