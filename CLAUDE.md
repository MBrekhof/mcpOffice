...
mcpOffice — MCP server (stdio) exposing Office document tools, written in C# / .NET 10. Word, Excel and PDF domains are shipped. PowerPoint was dropped from the roadmap (2026-09-02); open work is on the board.
